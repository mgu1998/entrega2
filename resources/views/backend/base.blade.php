                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <!-----------------------------------Noticias---------------------------------->
                             <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                  <li class="nav-item">
                                    <a href="{{ route('backend.noticias.index') }}" class="nav-link {{ $viewOpenTicket ?? '' }}"> {{-- if(isset($viewOpenTicket)) $viewOpenTicket else '' --}}
                                      <i class="far fa-circle nav-icon"></i>
                                      <p>Ver Noticias</p>
                                    </a>
                                  </li>
                                  <li class="nav-item">
                                    {{-- GET show {{ url('backend/ticket/1') }} --}}
                                    {{-- GET show {{ route('backend.ticket.show',['ticket'  => 1]) }}  --}}
                                    <a href="{{ route('backend.noticias.create') }}" class="nav-link {{ $viewCreateNoticias ?? '' }}">
                                      <i class="far fa-circle nav-icon"></i>
                                      <p>Crear Noticias</p>
                                    </a>
                                  </li>
